...
{
    [CustomEditor(typeof(CurvedConveyorBounds))]
    public class CurvedConveyorBoundsControllerEditor : UnityEditor.Editor
    {
        ...
        {
            CurvedConveyorBounds boundsController = (CurvedConveyorBounds)target;
            ...
            _boundsHandle.center = new Vector3(
                boundsController.transform.position.x + boundsController._bounds1.center.x,
                boundsController.transform.position.y + gridHeight,
                boundsController.transform.position.z + boundsController._bounds1.center.z);

            _boundsHandle.size = new Vector3(
                boundsController._bounds1.size.x,
                0,
                boundsController._bounds1.size.z);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                boundsController._bounds1 = newBounds;
            }
        }
    }
}